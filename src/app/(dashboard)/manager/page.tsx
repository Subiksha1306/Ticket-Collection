    ...
    <div className="space-y-6 pb-12 w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#fcfbff] rounded-2xl p-6 border border-[#e8e4ff] shadow-sm flex items-center justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="text-sm font-bold text-[#5B45FF] mb-1">August I2I Winner</div>
              <h3 className="text-lg font-bold text-gray-900 leading-tight">Bhuvaneshwaran Alagudurai</h3>
              <div className="text-sm text-gray-500 mt-1">Ticket 4119</div>
              <div className="text-sm text-gray-600 mt-1">Automated Deltek pay-period management</div>
            </div>
          </div>
          <div className="text-right border-l border-gray-200 pl-6 py-1">
            <div className="text-xl font-bold text-[#5B45FF]">97/100</div>
        ...
        <div className="bg-[#fafafa] rounded-2xl p-6 border border-gray-200 shadow-sm flex items-center justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold text-gray-900 leading-tight">Jesuraj Simionraj</h3>
              <div className="text-sm text-gray-500 mt-1">Ticket 4025</div>
            </div>
          </div>
          <div className="text-right border-l border-gray-200 pl-6 py-1">
            <div className="text-xl font-bold text-gray-600">93/100</div>
            <div className="w-full h-px bg-gray-200 my-2"></div>
          ...
          <div className="flex items-center justify-between relative px-4">
            ...
            <div className="flex flex-col items-center gap-3 bg-white z-10 px-2">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-gray-900 leading-none">24</div>
            ...
            <div className="flex flex-col items-center gap-3 bg-white z-10 px-2">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-gray-900 leading-none">5</div>
            ...
            <div className="flex flex-col items-center gap-3 bg-white z-10 px-2">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-gray-900 leading-none">8</div>
            ...
            <div className="flex flex-col items-center gap-3 bg-white z-10 px-2">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-gray-900 leading-none">12</div>
            ...
            <div className="flex flex-col items-center gap-3 bg-white z-10 px-2">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-gray-900 leading-none">6</div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col">
          ...
          <div className="flex-1 flex items-end justify-between px-2 pt-4 relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-between pointer-events-none pr-2 pb-6 text-[10px] text-gray-400">
              <div className="flex items-center gap-2 w-full"><span className="w-3 text-right">10</span><div className="flex-1 border-b border-gray-100 border-dashed"></div></div>
              <div className="flex items-center gap-2 w-full"><span className="w-3 text-right">8</span><div className="flex-1 border-b border-gray-100 border-dashed"></div></div>
              <div className="flex items-center gap-2 w-full"><span className="w-3 text-right">6</span><div className="flex-1 border-b border-gray-100 border-dashed"></div></div>
              <div className="flex items-center gap-2 w-full"><span className="w-3 text-right">4</span><div className="flex-1 border-b border-gray-100 border-dashed"></div></div>
              <div className="flex items-center gap-2 w-full"><span className="w-3 text-right">2</span><div className="flex-1 border-b border-gray-100 border-dashed"></div></div>
            ...
            <div className="relative z-10 w-full flex justify-between items-end pl-8 pb-6 h-full">
              <div className="flex flex-col items-center gap-2 w-12 group cursor-pointer">
                <span className="text-xs font-bold text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity">8</span>
                <div className="w-full bg-[#5B45FF] rounded-t-sm transition-all hover:bg-[#4a36d9]" style={{ height: '80%' }}></div>
                <div className="absolute -bottom-2 text-[10px] text-center text-gray-500 leading-tight w-20">Process<br/>Improvement</div>
              </div>
              <div className="flex flex-col items-center gap-2 w-12 group cursor-pointer">
                <span className="text-xs font-bold text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity">6</span>
                <div className="w-full bg-[#6C59FF] rounded-t-sm transition-all hover:bg-[#5B45FF]" style={{ height: '60%' }}></div>
                <div className="absolute -bottom-2 text-[10px] text-center text-gray-500 leading-tight w-20">Automation</div>
              </div>
              <div className="flex flex-col items-center gap-2 w-12 group cursor-pointer">
                <span className="text-xs font-bold text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity">4</span>
                <div className="w-full bg-[#7D6EFF] rounded-t-sm transition-all hover:bg-[#6C59FF]" style={{ height: '40%' }}></div>
                <div className="absolute -bottom-2 text-[10px] text-center text-gray-500 leading-tight w-20">Customer<br/>Experience</div>
              </div>
              <div className="flex flex-col items-center gap-2 w-12 group cursor-pointer">
                <span className="text-xs font-bold text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity">4</span>
                <div className="w-full bg-[#8F82FF] rounded-t-sm transition-all hover:bg-[#7D6EFF]" style={{ height: '40%' }}></div>
                <div className="absolute -bottom-2 text-[10px] text-center text-gray-500 leading-tight w-20">Cost<br/>Optimization</div>
              </div>
              <div className="flex flex-col items-center gap-2 w-12 group cursor-pointer">
                <span className="text-xs font-bold text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity">2</span>
                <div className="w-full bg-[#A196FF] rounded-t-sm transition-all hover:bg-[#8F82FF]" style={{ height: '20%' }}></div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <a href="#" className="text-sm font-semibold text-[#5B45FF] hover:text-[#4a36d9] flex items-center gap-1">
          ...
          <table className="min-w-full divide-y divide-gray-100">
            ...
            <tbody className="bg-white divide-y divide-gray-50">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">4221</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Improve Report Generation Performance</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Priya Sharma</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <span className="px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#fff4e6] text-[#e88d14]">Pending Review</span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">85/100</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">4219</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Automate User Access Provisioning</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Karthik Ramesh</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <span className="px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#fff4e6] text-[#e88d14]">Pending Review</span>
                </td>
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">4216</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Enhance Data Backup Process</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Anita Joseph</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <span className="px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#fff4e6] text-[#e88d14]">Pending Review</span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">82/100</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <button className="px-4 py-1.5 border border-[#5B45FF] text-[#5B45FF] rounded text-xs font-semibold hover:bg-[#f3f0ff] transition-colors">Review</button>
                </td>
              </tr>
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">4213</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Streamline Onboarding Checklist</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Vignesh Kumar</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <span className="px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#fff4e6] text-[#e88d14]">Pending Review</span>
                </td>
